...
***************************************************************************** */
        ...
        da.init();
        const videoSign = document.querySelector(".video");
        const videoStart = document.querySelector(".video_wide");
        const videoClip = document.querySelector("video");
        if (videoSign) videoSign.addEventListener("click", (function(e) {
            videoSign.classList.toggle("_active");
            if (videoSign.classList.contains("_active")) {
                videoStart.querySelector("video").play();
                videoClip.setAttribute("controls", "controls");
            } else {
                videoStart.querySelector("video").pause();
                videoClip.removeAttribute("controls", "controls");
            }
        }));
        window["FLS"] = true;
        isWebp();
